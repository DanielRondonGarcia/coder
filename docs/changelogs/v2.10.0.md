...
> [!NOTE]
> This is a mainline Coder release. We advise enterprise customers without a staging environment to install our [latest stable release](https://github.com/DanielRondonGarcia/coder/releases/latest) while we refine this version. Learn more about our [Release Schedule](../install/releases/index.md).
...
- Unhide support bundle command (#12745) (@johnstcn)
  ...
  > ![Coder Support Bundle](https://raw.githubusercontent.com/DanielRondonGarcia/coder/main/docs/changelogs/images/support-bundle.png)
...
Compare: [`v2.9.0...v2.10.0`](https://github.com/DanielRondonGarcia/coder/compare/v2.9.0...v2.10.0)

## Container image

- `docker pull ghcr.io/DanielRondonGarcia/coder:v2.10.0`
