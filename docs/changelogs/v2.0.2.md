...
- [External provisioners](https://coder.com/docs/admin/provisioners)
  ...
  - Provisioner daemons can be deployed
    [via Helm](https://github.com/DanielRondonGarcia/coder/tree/main/helm/provisioner)
    (#8939) (@spikecurtis)
...
- We now publish preview
  [container images](https://github.com/DanielRondonGarcia/coder/pkgs/container/coder-preview)
...
Compare:
[`v2.0.1...v2.0.2`](https://github.com/DanielRondonGarcia/coder/compare/v2.0.1...v2.0.2)

## Container image

- `docker pull ghcr.io/DanielRondonGarcia/coder:v2.0.2`
