...
- Add support for marking external auth providers as optional (#12021) (#12251) (@aslilac)
  > This is done via a [Terraform property](https://registry.terraform.io/providers/DanielRondonGarcia/coder/latest/docs/data-sources/external_auth#optional) in the template.
...
- Add activity status and autostop reason to workspace overview (#11987) (@aslilac)
  ![Autostop Cause Display](https://raw.githubusercontent.com/DanielRondonGarcia/coder/main/docs/changelogs/images/autostop-visibility.png)
...
- Add template activity_bump property (#11734) (@deansheather)
  ![Activity Bump](https://raw.githubusercontent.com/DanielRondonGarcia/coder/main/docs/changelogs/images/activity-bump.png)
...
- Port sharing: Allow users to share ports running in their workspace with other Coder users (#11939) (#12119) (#12383) (@deansheather) (@f0ssel)
  ![Port Sharing](https://raw.githubusercontent.com/DanielRondonGarcia/coder/main/docs/changelogs/images/sharable-ports.png)
...
Compare: [`v2.8.5...v2.9.0`](https://github.com/DanielRondonGarcia/coder/compare/v2.8.5...v2.9.0)

## Container image

- `docker pull ghcr.io/DanielRondonGarcia/coder:v2.9.0`
