...
- [Empeheral parameters](https://registry.terraform.io/providers/DanielRondonGarcia/coder/latest/docs/data-sources/parameter#ephemeral)
  allow users to specify a value for a single build (#8415) (#8524)
  ![Ephemeral parameters](https://github.com/DanielRondonGarcia/coder/assets/22407953/89df0888-9abc-453a-ac54-f5d0e221b0b9)
...
- Workspaces now appear `unhealthy` in the dashboard and CLI if one or more
  ...
  ![Workspace health](https://github.com/DanielRondonGarcia/coder/assets/22407953/edbb1d70-61b5-4b45-bfe8-51abdab417cc)
- Reverse port-forward with `coder ssh -R` (#8515)
- Helm: custom command arguments in Helm chart (#8567)
- Template version messages (#8435)
  <img width="428" alt="252772262-087f1338-f1e2-49fb-81f2-358070a46484" src="https://github.com/DanielRondonGarcia/coder/assets/22407953/5f6e5e47-e61b-41f1-92fe-f624e92f8bd3">
...
- Base container image contains [jq](https://github.com/DanielRondonGarcia/coder/pull/8563)
...
Compare:
[`v0.26.2...v0.27.0`](https://github.com/DanielRondonGarcia/coder/compare/v0.26.2...v0.27.0)

## Container image

- `docker pull ghcr.io/DanielRondonGarcia/coder:v0.26.2`
