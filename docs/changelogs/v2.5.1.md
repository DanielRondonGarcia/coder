...
- Add a user-configurable theme picker (#11140) (@aslilac)
  ...
  > A [light theme](https://github.com/DanielRondonGarcia/coder/issues/8396) is coming soon
...
Compare: [`v2.5.0...v2.5.1`](https://github.com/DanielRondonGarcia/coder/compare/v2.5.0...v2.5.1)

## Container image

- `docker pull ghcr.io/DanielRondonGarcia/coder:v2.5.1`
