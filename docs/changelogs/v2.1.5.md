...
- VS Code Insiders is no longer a default
  [display app](https://registry.terraform.io/providers/DanielRondonGarcia/coder/latest/docs/resources/agent#nested-schema-for-display_apps).
...
- You can show/hide specific
  [display apps](https://registry.terraform.io/providers/DanielRondonGarcia/coder/latest/docs/resources/agent#nested-schema-for-display_apps)
...
- Describe
  [dynamic options and locals for parameters](https://github.com/DanielRondonGarcia/coder/tree/main/examples/parameters-dynamic-options)
  (#9429) (@mtojek)
...
- `docker pull ghcr.io/DanielRondonGarcia/coder:v2.1.5`
