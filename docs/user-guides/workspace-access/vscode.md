...
automatically installs the [Coder Remote](https://github.com/DanielRondonGarcia/vscode-coder)
...
[latest release](https://github.com/DanielRondonGarcia/vscode-coder/releases/latest).
