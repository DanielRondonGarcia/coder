...
If you don't want to use the official modules, you can read through the [example template](https://github.com/DanielRondonGarcia/coder/tree/main/examples/jfrog/docker), which uses Docker as the underlying compute. The
...
- See the [full example Docker template](https://github.com/DanielRondonGarcia/coder/tree/main/examples/jfrog/docker).

- To serve extensions from your own VS Code Marketplace, check out
  [code-marketplace](https://github.com/DanielRondonGarcia/code-marketplace#artifactory-storage).
