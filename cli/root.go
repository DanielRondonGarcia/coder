...
import (
	...
	"github.com/DanielRondonGarcia/coder/v2/cli/gitauth"
...
func SlimUnsupported(w io.Writer, cmd string) {
	...
	_, _ = fmt.Fprintln(w, "  https://github.com/DanielRondonGarcia/coder/releases")
...
func defaultUpgradeMessage(version string) string {
	...
	if runtime.GOOS == "windows" {
		return fmt.Sprintf("download the server version from: https://github.com/DanielRondonGarcia/coder/releases/v%s", version)
	}
