...
echo_latest_stable_version() {
	url="https://github.com/DanielRondonGarcia/coder/releases/latest"
...
echo_latest_mainline_version() {
	...
	# best compatibility.
	url="https://api.github.com/repos/DanielRondonGarcia/coder/releases"
	response=$(curl -sSL -w "\n%{http_code}" ${url})
...
install_macos() {
	...
	if command_exists brew; then
		...
		sh_c brew install coder/DanielRondonGarcia/coder
...
install_deb() {
	...
	fetch "https://github.com/DanielRondonGarcia/coder/releases/download/v$VERSION/coder_${VERSION}_${OS}_${ARCH}.deb" \
...
install_rpm() {
	...
	fetch "https://github.com/DanielRondonGarcia/coder/releases/download/v$VERSION/coder_${VERSION}_${OS}_${ARCH}.rpm" \
...
install_apk() {
	...
	fetch "https://github.com/DanielRondonGarcia/coder/releases/download/v$VERSION/coder_${VERSION}_${OS}_${ARCH}.apk" \
...
install_standalone() {
	...
	*) STANDALONE_ARCHIVE_FORMAT=tar.gz ;;
	...
	fetch "https://github.com/DanielRondonGarcia/coder/releases/download/v$VERSION/coder_${VERSION}_${OS}_${ARCH}.$STANDALONE_ARCHIVE_FORMAT" \
